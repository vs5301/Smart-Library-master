...
import { Auth, createUserWithEmailAndPassword, signInWithEmailAndPassword, UserCredential, onAuthStateChanged } from '@angular/fire/auth';
...
export class AuthService {
  ...
  registerUser({ email, password }: { name: string; password: string; email: string }): Promise<UserCredential> {
    return new Promise((resolve, reject) =>{
